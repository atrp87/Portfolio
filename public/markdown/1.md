...
<section className='article__banner'>
  ![Netflix browse page.](/src/assets/article/content/netflix.png)
  <span className='article__banner-caption'>
  <strong>
      <a
      href='https://netflix-atrp87.vercel.app/'
      target='_blank'
...
![React.](/src/assets/article/content/netflix_details.png)
...
### Code Example: Navbar ( Event Delegation )
  ...
  <strong>
    <a
        href='https://github.com/atrp87/Netflix'
        target='_blank'
        rel='noopener noreferrer'
